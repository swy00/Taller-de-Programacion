...
public class Ej2P4 {
    ...
    public static void main(String[] args) {
        ...
        Jugadores j = new Jugadores(20,40,"Roberto",52000,1);//(int numPartidos, int numGoles, String nombre, double sueldo, int antigüedad)
        Entrenador e = new Entrenador(4,"Esteban",75000,4);//(int cantCampeonatos, String nombre, double sueldo, int antigüedad)
